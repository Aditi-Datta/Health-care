...
export default function SecondPart() {
  return (
    <Container maxWidth="lg" sx={{ mt: 9 }}>
      <Paper elevation={3}>
        <Box sx={{ p: 2.5 }}>
          <Typography variant="h5" fontWeight={'bold'}> Recent Appointment Patient Details </Typography>
          <Typography fontSize={12}>check it out--</Typography>
        </Box>
        <Divider></Divider>
        <TableContainer >
          <Table sx={{ minWidth: 650, mt: 3 }} size="small" aria-label="a dense table">
            <TableHead>
              <TableRow >
                ...
                <TableCell sx={{ fontWeight: 'bolder', fontSize: '16px' }}>PATIENT NAME</TableCell>
                <TableCell sx={{ fontWeight: 'bolder', fontSize: '16px' }}> PATIENT ID</TableCell>
                <TableCell sx={{ fontWeight: 'bolder', fontSize: '16px' }}>APPOINTMENT TO</TableCell>
