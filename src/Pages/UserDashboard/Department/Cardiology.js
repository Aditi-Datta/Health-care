    ...
    <Container style={{ paddingTop: '5%' }} >
      ...
      <Grid container direction="row"
        ...
        <Grid component="div" item xs={4} sm={6} md={4}>
          <img style={{
            position: 'relative', height: '55%', marginTop: '3%', marginRight: '10%', width: '85%', paddingLeft: '5%'
